...
```
backend/    FastAPI + SQLAlchemy + PostgreSQL — REST API, recommendation engine, Claude integration
...
1. Backend — see [`backend/README.md`](backend/README.md) (needs PostgreSQL + `ANTHROPIC_API_KEY`)
2. Frontend — see [`frontend/README.md`](frontend/README.md)
3. Scraper (optional, populates its own DB independently) — see [`scraper/README.md`](scraper/README.md)
